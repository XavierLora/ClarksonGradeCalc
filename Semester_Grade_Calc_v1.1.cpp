...
string username;                  // global var username and password     
char password[10];
...
string post_login(){
    string post_login_ans;
    cout<<"=================================================================" << endl;
    cout<<"Would you like to 'add' a class to this semester, check your current 'GPA', or modify your 'classes' (enter 'end' to terminate)? ";                 //Asking user if they want to add a class
    cin>>post_login_ans;
    return post_login_ans;
}
...
int main(){
    string Login_ans;                                                                       //Variable to store the answer to the login question                                                                               //Variable to store the id of the user
    Login_ans = login_screen();                                                         //Asks user to enter their answer to the login question
    ...
    do{
    if(id==1){
        post_login_ans = post_login();                                                 //Asks user to enter their answer to the post login question
        if(post_login_ans == "add"){                                                                    //If the user wants to add a class
            ...
            cout<<"Your class has been added." << endl;

        }
        else if(post_login_ans == "GPA"){                                                               //If the user wants to check their current GPA
            current_GPA();
        }
        else if(post_login_ans=="classes"){                                                             //If the user wants to modify their class list
            string class_change;
            int modify_ans;
            int class_num;
        ...
        else if(post_login_ans=="end"){                                                           //If the user wants to log out
